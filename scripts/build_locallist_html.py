...
<div class="shell">
  ...
  <article class="essay">
    ...
    <hr class="rule">
    <div class="body">
      <p>Ready or not, personal local language models (the smaller, more private, more efficient kind of LLMs) are coming to the people.</p>
      <p>Should the frontier labs be worried? Not immediately. But the band of revolutionaries taking charge are coming from bedrooms all over the world, wiring 220-volt outlets by hand at 2am. Thousands of these makeshift GPU-burning data-centre enthusiasts have clustered in a Discord server named LocalLLM, where the collective wisdom is to not ask permission from OpenAI or Anthropic to access intelligence. This is their story: a year’s worth of chatter and banter, directly from those who treat this hobby as their religion.</p>
      ...
      <p>However, the real excitement that month came from BlueFalcon, newly minted folk hero, who announced on August 17th that he was running something like two hundred simultaneous coding agents off a single RTX 4090 using gpt-oss-20b through vLLM’s live-batching, hitting nine thousand tokens a second, a cartoonish number that went semi-viral on Reddit and dragged the whole Discord into a week of agent-orchestration theology. BlueFalcon delivered this triumph the way a man delivers a toast at his own wedding, unable to resist the bit: “WE MUST CONSTRUCT ADDITIONAL PYLONS,” with an honest admission that “tool calling in oss-20b is fucking broken.” CoralAnchor, watching from the exile bench, replied, “I keep coming back to the idea that I’d probably have a nervous breakdown at having to code review that much stuff.”</p>
      <p>The debate over hardware would also become prevalent. People either went the CPU (Apple) or GPU (any random graphics card you have lying around) route. BlueFalcon summed up the Mac-versus-Nvidia debate in one line that month: “Apple computers have the RAM capacity, but not enough compute power; NVIDIA is the opposite.”</p>
